...
(* OASIS_START *)
(* DO NOT EDIT (digest: a9cf9522bddbd6ff6acbc0773d41b8e6) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/fxfactorial/ocaml-qjsengine";
                        ...
                        [
                           ...
                           (OASISExpr.ETest ("system", "macosx"),
                             [
                                ...
                                "-fPIC";
                                "-stdlib=libc++";
                                "-F/usr/local/Cellar/qt5/5.6.1-1/lib";
                                "-framework";
                                "QtCore";
                                "-F/usr/local/Cellar/qt5/5.6.1-1/lib";
                                "-framework";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "qjsengine"];
                      bs_build_tools =
                        [
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/fxfactorial/ocaml-qjsengine.git";
                      src_repo_browser =
                        Some "https://github.com/fxfactorial/ocaml-qjsengine";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "HS\139\235\030\131A\r\1810\176\233\020\199\195\"";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
