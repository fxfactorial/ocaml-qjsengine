...
let package_default =
  {
     ...
     flags =
       [
          ...
          (["oasis_library_qjsengine_native"; "ocaml"; "link"; "native"],
            [
               (OASISExpr.EBool true,
                 S [A "-g"; A "-w"; A "+a-4-40..42-44-45-48"])
            ]);
          (["oasis_library_qjsengine_byte"; "ocaml"; "ocamldep"; "byte"],
            [
               (OASISExpr.EBool true,
                 S [A "-g"; A "-w"; A "+a-4-40..42-44-45-48"])
            ]);
          (["oasis_library_qjsengine_native"; "ocaml"; "ocamldep"; "native"],
            [
               (OASISExpr.EBool true,
                 S [A "-g"; A "-w"; A "+a-4-40..42-44-45-48"])
            ]);
          (["oasis_library_qjsengine_byte"; "ocaml"; "compile"; "byte"],
            [
               (OASISExpr.EBool true,
                 S [A "-g"; A "-w"; A "+a-4-40..42-44-45-48"])
            ]);
          (["oasis_library_qjsengine_native"; "ocaml"; "compile"; "native"],
            [
               (OASISExpr.EBool true,
                 S [A "-g"; A "-w"; A "+a-4-40..42-44-45-48"])
            ]);
...
let () =
  ...
  Ocamlbuild_plugin.run_and_read
    "PKG_CONFIG_PATH=/usr/local/opt/qt5/lib/pkgconfig \
     pkg-config --cflags \
     /usr/local/opt/qt5/lib/pkgconfig/Qt5Core.pc \
     /usr/local/opt/qt5/lib/pkgconfig/Qt5Qml.pc"
  |> String.trim
  in
...
let cc_libs =
  ...
  (* print_endline cc_opts; *)
  (* print_endline cc_libs; *)
